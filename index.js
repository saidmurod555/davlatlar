...
function setData(myJson, children, section, recursion) {
  ...
  for (var i = 0; i < myJson.length; i++) {
    if (
      myJson[i].name.toLowerCase() ===
      (recursion ? children.toLowerCase() : children[1].innerText.toLowerCase())
    ) {
      ...
      section[0].querySelectorAll(".native-name")[0].innerText =
        myJson[i].nativeName;
      ...
      if (myJson[i] && myJson[i].currencies) {
        section[0].querySelectorAll(".currencies")[0].innerText =
          myJson[i].currencies[0].name;
      } else {
        section[0].querySelectorAll(".currencies")[0].innerText = "";
      }
      section[0].querySelectorAll(".population")[0].innerText =
        myJson[i].population;
      section[0].querySelectorAll(".sub-region")[0].innerText =
        myJson[i].subregion;
      section[0].querySelectorAll(".tld")[0].innerText =
        myJson[i].topLevelDomain[0];
